...
# MAGIC %md
# MAGIC # Simple Ingest-Bronze-Silver SDP Example
# MAGIC This Spark Declarative Pipeline(SDP) provides a basic example, demonstrating how to set expectations on tables. It serves as a starting point, and you can easily add more tables or expectations based on your specific needs. For simplicity, this example will focus on the essentials.
# MAGIC
...
# MAGIC This raw source data path and catalog will dynamically be set using the configuration variable set in the Spark Declarative Pipeline for each environment: **development**, **stage**, or **production**.
# MAGIC
