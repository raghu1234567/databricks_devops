...
# MAGIC
# MAGIC     - **Notebook 1: [..../src/sdp/ingest-bronze-silver_sdp]($../../src/sdp/ingest-bronze-silver_sdp)** - Obtains the Spark Declarative Pipeline configuration variables that setup the target and raw data, and creates the bronze and silver tables based on those variable values.
# MAGIC   
# MAGIC     - **Notebook 2: [..../src/sdp/gold_tables_sdp]($../../src/sdp/gold_tables_sdp)** - Creates the gold table.
# MAGIC   
