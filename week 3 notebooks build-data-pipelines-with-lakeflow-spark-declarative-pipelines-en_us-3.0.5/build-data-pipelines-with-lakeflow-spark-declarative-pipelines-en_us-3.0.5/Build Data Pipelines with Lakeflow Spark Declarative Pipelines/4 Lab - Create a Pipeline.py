...
# MAGIC %sql
# MAGIC SELECT *
# MAGIC FROM lab_1_bronze_db.employees_bronze_lab4_solution;
...
# MAGIC %sql
# MAGIC SELECT *
# MAGIC FROM lab_2_silver_db.employees_silver_lab4_solution;
...
# MAGIC %sql
# MAGIC SELECT *
# MAGIC FROM lab_3_gold_db.employees_by_country_gold_lab4_solution
...
# MAGIC %sql
# MAGIC SELECT *
# MAGIC FROM lab_3_gold_db.salary_by_department_gold_lab4_solution
# MAGIC ORDER BY TotalSalary;
